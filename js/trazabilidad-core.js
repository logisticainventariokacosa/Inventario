...
class TrazabilidadCore {
    constructor() {
        ...
        this.materialesConFactor = new Map([
            ...
            // Materiales con G (gramos) - NUEVOS
            ['1000013461', {unidad: 'G', factor: 10900}],
            ['1000012907', {unidad: 'G', factor: 13600}],
            ['1000009740', {unidad: 'G', factor: 11300}],
            ['1000017132', {unidad: 'G', factor: 11300}],
            ['1000011789', {unidad: 'G', factor: 5000}],
            ['1000012597', {unidad: 'G', factor: 11350}],
            ['1000017743', {unidad: 'G', factor: 10900}],
            ['1000015728', {unidad: 'G', factor: 13600}],
            ['1000012399', {unidad: 'G', factor: 11300}],
            ['1000037818', {unidad: 'G', factor: 11300}],
            ['1000012934', {unidad: 'G', factor: 11300}],
            ['1000017966', {unidad: 'G', factor: 11350}],
            ['1000020985', {unidad: 'G', factor: 5000}],
            ['1000012284', {unidad: 'G', factor: 3000}],
            ['1000009052', {unidad: 'G', factor: 12300}],
            ['1000008244', {unidad: 'G', factor: 11350}],
            ['1000011315', {unidad: 'G', factor: 13600}],
            ['1000008245', {unidad: 'G', factor: 12250}],
            ['1000012599', {unidad: 'G', factor: 13600}],
            ['1000018312', {unidad: 'G', factor: 13600}],
            ['1000012285', {unidad: 'G', factor: 13600}],
            ['1000001891', {unidad: 'G', factor: 11300}],
            ['1000008247', {unidad: 'G', factor: 13790}],
            ['1000008826', {unidad: 'G', factor: 13600}],
            ['1000008848', {unidad: 'G', factor: 11350}],
            ['1000008902', {unidad: 'G', factor: 11350}],
            ['1000008908', {unidad: 'G', factor: 11300}],
            ['1000011213', {unidad: 'G', factor: 6500}],
            ['1000012728', {unidad: 'G', factor: 13600}],
            ['1000017113', {unidad: 'G', factor: 13600}],
            ['1000017746', {unidad: 'G', factor: 11300}],
            ['1000017768', {unidad: 'G', factor: 10900}],
            ['1000017850', {unidad: 'G', factor: 11300}],
            ['1000018024', {unidad: 'G', factor: 13600}],
            ['1000019286', {unidad: 'G', factor: 13600}],
            ['1000027370', {unidad: 'G', factor: 5000}],
            ['1000027371', {unidad: 'G', factor: 11300}],
